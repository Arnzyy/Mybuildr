...
export default function InteractiveDemo() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gray-50" id="demo">
      <div className="section-container">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg border border-gray-200 overflow-hidden shadow-lg">
          ...
          <div className="flex gap-0 border-b border-gray-200 bg-gray-50 overflow-x-auto">
            {COPY.demo.tabs.map((tab) => (
              ...
              >
                ...
                <div className="text-xs text-gray-500 mt-1 hidden md:block">{tab.description}</div>
              </button>
            ))}
          </div>
          ...
          <div className="aspect-video md:aspect-auto md:h-96 bg-gray-100 relative overflow-hidden">
            {activeTab === 'website' && (
              <div className="w-full h-full flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-orange-50 to-white">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm max-w-sm">Mobile-first design that makes your trade business look professional and trustworthy.</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'admin' && (
              <div className="w-full h-full flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-green-50 to-white">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm max-w-sm">Drag and drop your project photos. Set your posting schedule. That&apos;s it.</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'instagram' && (
              <div className="w-full h-full flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-purple-50 to-white">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm max-w-sm">Your projects posted to Instagram, Facebook, and Google automatically. 5x per week.</p>
                </div>
              </div>
            )}
          </div>

          <div className="px-4 md:px-6 py-4 bg-orange-50 border-t border-orange-100">
            <p className="text-sm text-orange-900">
              <strong>Pro tip:</strong> Click the tabs above to see the full workflow. Website → Upload images → Automatic posts to social.
            </p>
          </div>
        </div>
      </div>
